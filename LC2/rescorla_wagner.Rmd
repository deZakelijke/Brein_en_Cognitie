...
data1 = rescola(v_start, v_max, alpha, num_trials)
data1
```
...
```{r}
alpha = 0.2
data2 = rescola(v_start, v_max, alpha, num_trials)
...
```{r}
plot(seq(v_start, num_trials), data1$delta_v, xlab = "Number of trials", ylab = "V")
lines(seq(from=v_start, to=num_trials), data1$delta_v,col="black",lwd=2)
points(seq(from=v_start, to=num_trials), data2$delta_v,col="black")
lines(seq(from=v_start, to=num_trials), data2$delta_v,col="black",lwd=2)
```
