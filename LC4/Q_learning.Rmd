...
Als we ook de initiele waarde van de acties vrij laten krijgen we het volgende optimale model. In dit geval gebruiken we een verschillende $\alpa$ voor positieve fouten en negatieve fouten:
